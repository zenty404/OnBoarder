// ============================================================
// PAGE : OPPORTUNITES (Liste des Opportunites clientes)
// ============================================================
...
/** Informations de l'Opportunites connecté (simulé) */
const utilisateur = {
  ...
  return (
    ...
    <div className="flex h-full min-h-screen">
      ...
      <div className="flex flex-1 flex-col">
        ...
        {/* ---------------------------------------------------- */}
        {/* CONTENU PRINCIPAL : Grilles Opportunités       */}
        {/* ---------------------------------------------------- */}
        <main className="flex-1 overflow-y-auto p-8">

          {/* ================================================== */}
          {/* BOUTON "AJOUTER UNE Opportunités"                      */}
          {/* ================================================== */}
